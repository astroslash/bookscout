...
This document records the supplied North Star and build specification. The current implementation is **Phase 1 only**; later-phase requirements below are design targets, not claims of implemented behavior.
