...
- `GET /api/book-scout` returns the manifest, tool list, health flag, deployment commit, and safe catalog diagnostics (schema version, approved count, checksum). It exposes no API keys.
